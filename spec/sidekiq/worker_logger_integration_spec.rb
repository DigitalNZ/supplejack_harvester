...
RSpec.describe 'Worker Logger Integration' do
  ...
  describe 'EnrichmentExtractionWorker' do
    ...
    it 'calls logger when error is raised' do
      ...
      expect(Supplejack::JobCompletionSummaryLogger).to receive(:log_completion).with(
        hash_including(
  ...
  describe 'Stop Condition Logging' do
    ...
    it 'logs stop condition when details contain stop_condition_name' do
      ...
      allow(Supplejack::JobCompletionSummaryLogger).to receive(:log_completion).and_call_original
    ...
    it 'logs stop condition when stop condition details are provided' do
      ...
      expect { Supplejack::JobCompletionSummaryLogger.log_completion(stop_condition_args) }.to change(JobCompletionSummary, :count).by(1)
