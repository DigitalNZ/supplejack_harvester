...
RSpec.describe Extraction::RecordExtraction do
  ...
  describe '#extract' do
    ...
    context "when the extraction definition runs in incremental mode" do
      ...
      let(:extraction_definition) { create(:extraction_definition, :enrichment, destination:, incremental: true) }
